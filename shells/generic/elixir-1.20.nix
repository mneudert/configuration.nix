...
let
  ...
  elixir = pkgs.callPackage /data/projects/private/configuration.nix/packages/elixir-1.20 {
    erlang = erlang_28;
  };
in
stdenv.mkDerivation rec {
  name = "generic-shell-elixir-1.20";
  ...
  shellHook = ''
    ...
    export PS1="[generic:elixir-1.20|\[\e[1m\]\w\[\e[0m\]]$ "
  '';
