...
stdenv.mkDerivation rec {
  name = "generic-shell-elixir-1.14";
  env = buildEnv {
    name = name;
    paths = buildInputs;
  };
  ...
  shellHook = ''
    ...
    export PS1="[generic:elixir-1.14|\[\e[1m\]\w\[\e[0m\]]$ "
  '';

  elixir = pkgs.callPackage /data/projects/private/configuration.nix/packages/elixir-1.14 {
    erlang = erlang_26;
  };
