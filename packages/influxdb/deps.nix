...
[
  ...
  }
  {
    ...
    fetch= {
      type= "git";
      url= "https://github.com/c-bata/go-prompt.git";
  ...
  }
  {
    ...
    fetch= {
      type= "git";
      url= "https://github.com/influxdata/line-protocol.git";
  ...
  }
  {
    ...
    fetch= {
      type= "git";
      url= "https://github.com/influxdata/roaring.git";
  ...
  }
  {
    ...
    fetch= {
      type= "git";
      url= "https://github.com/influxdata/tdigest.git";
